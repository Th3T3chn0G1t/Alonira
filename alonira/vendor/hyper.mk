...
HYPER_STAGE2_CFLAGS += -I$(ALONIRA_DIR)/alonira/vendor/Hyper/loader -I$(ALONIRA_DIR)/alonira/vendor/Hyper/loader/bios
...
$(HYPER_STAGE2_ELF): TARGET_LFLAGS = $(HYPER_STAGE2_L_FLAGS)
