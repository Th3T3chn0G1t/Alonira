...
gen_error_t* alo_exceptions_populate_idt(void) {
    ...
    alo_idt[ALO_INTERRUPT_VECTOR_EXCEPTION_DIVIDE_BY_ZERO] = ALO_IDT_MAKE_ENTRY((gen_uintptr_t) alo_exception_handler_divide_by_zero, ALO_IST_NONE, ALO_IDT_GATE_TYPE_TRAP, ALO_CPU_PRIVILEGE_RING0);
    alo_idt[ALO_INTERRUPT_VECTOR_EXCEPTION_DEBUG_TRAP] = ALO_IDT_MAKE_ENTRY((gen_uintptr_t) alo_exception_handler_debug_trap, ALO_IST_NONE, ALO_IDT_GATE_TYPE_TRAP, ALO_CPU_PRIVILEGE_RING0);
    alo_idt[ALO_INTERRUPT_VECTOR_EXCEPTION_NMI] = ALO_IDT_MAKE_ENTRY((gen_uintptr_t) alo_exception_handler_nmi, ALO_IST_NONE, ALO_IDT_GATE_TYPE_TRAP, ALO_CPU_PRIVILEGE_RING0);
    alo_idt[ALO_INTERRUPT_VECTOR_EXCEPTION_BREAKPOINT] = ALO_IDT_MAKE_ENTRY((gen_uintptr_t) alo_exception_handler_breakpoint, ALO_IST_NONE, ALO_IDT_GATE_TYPE_TRAP, ALO_CPU_PRIVILEGE_RING0);
    alo_idt[ALO_INTERRUPT_VECTOR_EXCEPTION_OVERFLOW] = ALO_IDT_MAKE_ENTRY((gen_uintptr_t) alo_exception_handler_overflow, ALO_IST_NONE, ALO_IDT_GATE_TYPE_TRAP, ALO_CPU_PRIVILEGE_RING0);
    alo_idt[ALO_INTERRUPT_VECTOR_EXCEPTION_BOUND_RANGE_EXCEEDED] = ALO_IDT_MAKE_ENTRY((gen_uintptr_t) alo_exception_handler_bound_range_exceeded, ALO_IST_NONE, ALO_IDT_GATE_TYPE_TRAP, ALO_CPU_PRIVILEGE_RING0);
    alo_idt[ALO_INTERRUPT_VECTOR_EXCEPTION_INVALID_OPCODE] = ALO_IDT_MAKE_ENTRY((gen_uintptr_t) alo_exception_handler_invalid_opcode, ALO_IST_NONE, ALO_IDT_GATE_TYPE_TRAP, ALO_CPU_PRIVILEGE_RING0);
    alo_idt[ALO_INTERRUPT_VECTOR_EXCEPTION_DEVICE_NOT_AVILABLE] = ALO_IDT_MAKE_ENTRY((gen_uintptr_t) alo_exception_handler_device_not_avilable, ALO_IST_NONE, ALO_IDT_GATE_TYPE_TRAP, ALO_CPU_PRIVILEGE_RING0);
    alo_idt[ALO_INTERRUPT_VECTOR_EXCEPTION_DOUBLE_FAULT] = ALO_IDT_MAKE_ENTRY((gen_uintptr_t) alo_exception_handler_double_fault, ALO_IST_NONE, ALO_IDT_GATE_TYPE_TRAP, ALO_CPU_PRIVILEGE_RING0);
    alo_idt[ALO_INTERRUPT_VECTOR_EXCEPTION_COPROCESSOR_SEGMENT_OVERRUN] = ALO_IDT_MAKE_ENTRY((gen_uintptr_t) alo_exception_handler_coprocessor_segment_overrun, ALO_IST_NONE, ALO_IDT_GATE_TYPE_TRAP, ALO_CPU_PRIVILEGE_RING0);
    alo_idt[ALO_INTERRUPT_VECTOR_EXCEPTION_INVALID_TSS] = ALO_IDT_MAKE_ENTRY((gen_uintptr_t) alo_exception_handler_invalid_tss, ALO_IST_NONE, ALO_IDT_GATE_TYPE_TRAP, ALO_CPU_PRIVILEGE_RING0);
    alo_idt[ALO_INTERRUPT_VECTOR_EXCEPTION_SEGMENT_NOT_PRESENT] = ALO_IDT_MAKE_ENTRY((gen_uintptr_t) alo_exception_handler_segment_not_present, ALO_IST_NONE, ALO_IDT_GATE_TYPE_TRAP, ALO_CPU_PRIVILEGE_RING0);
    alo_idt[ALO_INTERRUPT_VECTOR_EXCEPTION_STACK_SEGMENT_FAULT] = ALO_IDT_MAKE_ENTRY((gen_uintptr_t) alo_exception_handler_stack_segment_fault, ALO_IST_NONE, ALO_IDT_GATE_TYPE_TRAP, ALO_CPU_PRIVILEGE_RING0);
    alo_idt[ALO_INTERRUPT_VECTOR_EXCEPTION_GENERAL_PROTECTION_FAULT] = ALO_IDT_MAKE_ENTRY((gen_uintptr_t) alo_exception_handler_general_protection_fault, ALO_IST_NONE, ALO_IDT_GATE_TYPE_TRAP, ALO_CPU_PRIVILEGE_RING0);
    alo_idt[ALO_INTERRUPT_VECTOR_EXCEPTION_PAGE_FAULT] = ALO_IDT_MAKE_ENTRY((gen_uintptr_t) alo_exception_handler_page_fault, ALO_IST_NONE, ALO_IDT_GATE_TYPE_TRAP, ALO_CPU_PRIVILEGE_RING0);
    alo_idt[ALO_INTERRUPT_VECTOR_EXCEPTION_RESERVED0] = ALO_IDT_MAKE_ENTRY((gen_uintptr_t) alo_exception_handler_reserved0, ALO_IST_NONE, ALO_IDT_GATE_TYPE_TRAP, ALO_CPU_PRIVILEGE_RING0);
    alo_idt[ALO_INTERRUPT_VECTOR_EXCEPTION_X87_FLOATING_POINT] = ALO_IDT_MAKE_ENTRY((gen_uintptr_t) alo_exception_handler_x87_floating_point, ALO_IST_NONE, ALO_IDT_GATE_TYPE_TRAP, ALO_CPU_PRIVILEGE_RING0);
    alo_idt[ALO_INTERRUPT_VECTOR_EXCEPTION_ALIGNMENT_CHECK] = ALO_IDT_MAKE_ENTRY((gen_uintptr_t) alo_exception_handler_alignment_check, ALO_IST_NONE, ALO_IDT_GATE_TYPE_TRAP, ALO_CPU_PRIVILEGE_RING0);
    alo_idt[ALO_INTERRUPT_VECTOR_EXCEPTION_MACHINE_CHECK] = ALO_IDT_MAKE_ENTRY((gen_uintptr_t) alo_exception_handler_machine_check, ALO_IST_NONE, ALO_IDT_GATE_TYPE_TRAP, ALO_CPU_PRIVILEGE_RING0);
    alo_idt[ALO_INTERRUPT_VECTOR_EXCEPTION_SIMD_FLOATING_POINT] = ALO_IDT_MAKE_ENTRY((gen_uintptr_t) alo_exception_handler_simd_floating_point, ALO_IST_NONE, ALO_IDT_GATE_TYPE_TRAP, ALO_CPU_PRIVILEGE_RING0);
    alo_idt[ALO_INTERRUPT_VECTOR_EXCEPTION_VIRTUALIZATION] = ALO_IDT_MAKE_ENTRY((gen_uintptr_t) alo_exception_handler_virtualization, ALO_IST_NONE, ALO_IDT_GATE_TYPE_TRAP, ALO_CPU_PRIVILEGE_RING0);
    alo_idt[ALO_INTERRUPT_VECTOR_EXCEPTION_CONTROL_PROTECTION] = ALO_IDT_MAKE_ENTRY((gen_uintptr_t) alo_exception_handler_control_protection, ALO_IST_NONE, ALO_IDT_GATE_TYPE_TRAP, ALO_CPU_PRIVILEGE_RING0);
    alo_idt[ALO_INTERRUPT_VECTOR_EXCEPTION_RESERVED1] = ALO_IDT_MAKE_ENTRY((gen_uintptr_t) alo_exception_handler_reserved1, ALO_IST_NONE, ALO_IDT_GATE_TYPE_TRAP, ALO_CPU_PRIVILEGE_RING0);
    alo_idt[ALO_INTERRUPT_VECTOR_EXCEPTION_RESERVED2] = ALO_IDT_MAKE_ENTRY((gen_uintptr_t) alo_exception_handler_reserved2, ALO_IST_NONE, ALO_IDT_GATE_TYPE_TRAP, ALO_CPU_PRIVILEGE_RING0);
    alo_idt[ALO_INTERRUPT_VECTOR_EXCEPTION_RESERVED3] = ALO_IDT_MAKE_ENTRY((gen_uintptr_t) alo_exception_handler_reserved3, ALO_IST_NONE, ALO_IDT_GATE_TYPE_TRAP, ALO_CPU_PRIVILEGE_RING0);
    alo_idt[ALO_INTERRUPT_VECTOR_EXCEPTION_RESERVED4] = ALO_IDT_MAKE_ENTRY((gen_uintptr_t) alo_exception_handler_reserved4, ALO_IST_NONE, ALO_IDT_GATE_TYPE_TRAP, ALO_CPU_PRIVILEGE_RING0);
    alo_idt[ALO_INTERRUPT_VECTOR_EXCEPTION_RESERVED5] = ALO_IDT_MAKE_ENTRY((gen_uintptr_t) alo_exception_handler_reserved5, ALO_IST_NONE, ALO_IDT_GATE_TYPE_TRAP, ALO_CPU_PRIVILEGE_RING0);
    alo_idt[ALO_INTERRUPT_VECTOR_EXCEPTION_RESERVED6] = ALO_IDT_MAKE_ENTRY((gen_uintptr_t) alo_exception_handler_reserved6, ALO_IST_NONE, ALO_IDT_GATE_TYPE_TRAP, ALO_CPU_PRIVILEGE_RING0);
    alo_idt[ALO_INTERRUPT_VECTOR_EXCEPTION_HYPERVISOR_INJECTION] = ALO_IDT_MAKE_ENTRY((gen_uintptr_t) alo_exception_handler_hypervisor_injection, ALO_IST_NONE, ALO_IDT_GATE_TYPE_TRAP, ALO_CPU_PRIVILEGE_RING0);
    alo_idt[ALO_INTERRUPT_VECTOR_EXCEPTION_VMM_COMMUNICATION] = ALO_IDT_MAKE_ENTRY((gen_uintptr_t) alo_exception_handler_vmm_communication, ALO_IST_NONE, ALO_IDT_GATE_TYPE_TRAP, ALO_CPU_PRIVILEGE_RING0);
    alo_idt[ALO_INTERRUPT_VECTOR_EXCEPTION_SECURITY] = ALO_IDT_MAKE_ENTRY((gen_uintptr_t) alo_exception_handler_security, ALO_IST_NONE, ALO_IDT_GATE_TYPE_TRAP, ALO_CPU_PRIVILEGE_RING0);
    alo_idt[ALO_INTERRUPT_VECTOR_EXCEPTION_RESERVED7] = ALO_IDT_MAKE_ENTRY((gen_uintptr_t) alo_exception_handler_reserved7, ALO_IST_NONE, ALO_IDT_GATE_TYPE_TRAP, ALO_CPU_PRIVILEGE_RING0);
