...
GEN_NORETURN ALO_INTERRUPT_HANDLER_CALLABLE_ATTRIBUTES GEN_USED void alo_interrupts_internal_exception_stub(void) {
    ...
    error = gen_error_attach_backtrace(GEN_ERROR_UNKNOWN, GEN_LINE_NUMBER, "Exception");
    gen_error_abort_with_error(error, "alonira-interrupts");
}

GEN_DONT_SANITIZE_UNDEFINED GEN_NAKED static void alo_interrupts_internal_exception_handler_divide_by_zero              (void) { ALO_INTERRUPTS_ISR_BODY(ALO_INTERRUPT_VECTOR_EXCEPTION_DIVIDE_BY_ZERO              , alo_interrupts_internal_exception_frame, alo_interrupts_internal_exception_stub, ALO_INTERRUPTS_NO_ERROR_CODE); }
GEN_DONT_SANITIZE_UNDEFINED GEN_NAKED static void alo_interrupts_internal_exception_handler_debug_trap                  (void) { ALO_INTERRUPTS_ISR_BODY(ALO_INTERRUPT_VECTOR_EXCEPTION_DEBUG_TRAP                  , alo_interrupts_internal_exception_frame, alo_interrupts_internal_exception_stub, ALO_INTERRUPTS_NO_ERROR_CODE); }
GEN_DONT_SANITIZE_UNDEFINED GEN_NAKED static void alo_interrupts_internal_exception_handler_nmi                         (void) { ALO_INTERRUPTS_ISR_BODY(ALO_INTERRUPT_VECTOR_EXCEPTION_NMI                         , alo_interrupts_internal_exception_frame, alo_interrupts_internal_exception_stub, ALO_INTERRUPTS_NO_ERROR_CODE); }
GEN_DONT_SANITIZE_UNDEFINED GEN_NAKED static void alo_interrupts_internal_exception_handler_breakpoint                  (void) { ALO_INTERRUPTS_ISR_BODY(ALO_INTERRUPT_VECTOR_EXCEPTION_BREAKPOINT                  , alo_interrupts_internal_exception_frame, alo_interrupts_internal_exception_stub, ALO_INTERRUPTS_NO_ERROR_CODE); }
GEN_DONT_SANITIZE_UNDEFINED GEN_NAKED static void alo_interrupts_internal_exception_handler_overflow                    (void) { ALO_INTERRUPTS_ISR_BODY(ALO_INTERRUPT_VECTOR_EXCEPTION_OVERFLOW                    , alo_interrupts_internal_exception_frame, alo_interrupts_internal_exception_stub, ALO_INTERRUPTS_NO_ERROR_CODE); }
GEN_DONT_SANITIZE_UNDEFINED GEN_NAKED static void alo_interrupts_internal_exception_handler_bound_range_exceeded        (void) { ALO_INTERRUPTS_ISR_BODY(ALO_INTERRUPT_VECTOR_EXCEPTION_BOUND_RANGE_EXCEEDED        , alo_interrupts_internal_exception_frame, alo_interrupts_internal_exception_stub, ALO_INTERRUPTS_NO_ERROR_CODE); }
GEN_DONT_SANITIZE_UNDEFINED GEN_NAKED static void alo_interrupts_internal_exception_handler_invalid_opcode              (void) { ALO_INTERRUPTS_ISR_BODY(ALO_INTERRUPT_VECTOR_EXCEPTION_INVALID_OPCODE              , alo_interrupts_internal_exception_frame, alo_interrupts_internal_exception_stub, ALO_INTERRUPTS_NO_ERROR_CODE); }
GEN_DONT_SANITIZE_UNDEFINED GEN_NAKED static void alo_interrupts_internal_exception_handler_device_not_available        (void) { ALO_INTERRUPTS_ISR_BODY(ALO_INTERRUPT_VECTOR_EXCEPTION_DEVICE_NOT_AVAILABLE        , alo_interrupts_internal_exception_frame, alo_interrupts_internal_exception_stub, ALO_INTERRUPTS_NO_ERROR_CODE); }
GEN_DONT_SANITIZE_UNDEFINED GEN_NAKED static void alo_interrupts_internal_exception_handler_double_fault                (void) { ALO_INTERRUPTS_ISR_BODY(ALO_INTERRUPT_VECTOR_EXCEPTION_DOUBLE_FAULT                , alo_interrupts_internal_exception_frame, alo_interrupts_internal_exception_stub, ALO_INTERRUPTS_ERROR_CODE   ); }
GEN_DONT_SANITIZE_UNDEFINED GEN_NAKED static void alo_interrupts_internal_exception_handler_coprocessor_segment_overrun (void) { ALO_INTERRUPTS_ISR_BODY(ALO_INTERRUPT_VECTOR_EXCEPTION_COPROCESSOR_SEGMENT_OVERRUN , alo_interrupts_internal_exception_frame, alo_interrupts_internal_exception_stub, ALO_INTERRUPTS_NO_ERROR_CODE); }
GEN_DONT_SANITIZE_UNDEFINED GEN_NAKED static void alo_interrupts_internal_exception_handler_invalid_tss                 (void) { ALO_INTERRUPTS_ISR_BODY(ALO_INTERRUPT_VECTOR_EXCEPTION_INVALID_TSS                 , alo_interrupts_internal_exception_frame, alo_interrupts_internal_exception_stub, ALO_INTERRUPTS_ERROR_CODE   ); }
GEN_DONT_SANITIZE_UNDEFINED GEN_NAKED static void alo_interrupts_internal_exception_handler_segment_not_present         (void) { ALO_INTERRUPTS_ISR_BODY(ALO_INTERRUPT_VECTOR_EXCEPTION_SEGMENT_NOT_PRESENT         , alo_interrupts_internal_exception_frame, alo_interrupts_internal_exception_stub, ALO_INTERRUPTS_ERROR_CODE   ); }
GEN_DONT_SANITIZE_UNDEFINED GEN_NAKED static void alo_interrupts_internal_exception_handler_stack_segment_fault         (void) { ALO_INTERRUPTS_ISR_BODY(ALO_INTERRUPT_VECTOR_EXCEPTION_STACK_SEGMENT_FAULT         , alo_interrupts_internal_exception_frame, alo_interrupts_internal_exception_stub, ALO_INTERRUPTS_ERROR_CODE   ); }
GEN_DONT_SANITIZE_UNDEFINED GEN_NAKED static void alo_interrupts_internal_exception_handler_general_protection_fault    (void) { ALO_INTERRUPTS_ISR_BODY(ALO_INTERRUPT_VECTOR_EXCEPTION_GENERAL_PROTECTION_FAULT    , alo_interrupts_internal_exception_frame, alo_interrupts_internal_exception_stub, ALO_INTERRUPTS_ERROR_CODE   ); }
GEN_DONT_SANITIZE_UNDEFINED GEN_NAKED static void alo_interrupts_internal_exception_handler_page_fault                  (void) { ALO_INTERRUPTS_ISR_BODY(ALO_INTERRUPT_VECTOR_EXCEPTION_PAGE_FAULT                  , alo_interrupts_internal_exception_frame, alo_interrupts_internal_exception_stub, ALO_INTERRUPTS_ERROR_CODE   ); }
GEN_DONT_SANITIZE_UNDEFINED GEN_NAKED static void alo_interrupts_internal_exception_handler_reserved0                   (void) { ALO_INTERRUPTS_ISR_BODY(ALO_INTERRUPT_VECTOR_EXCEPTION_RESERVED0                   , alo_interrupts_internal_exception_frame, alo_interrupts_internal_exception_stub, ALO_INTERRUPTS_NO_ERROR_CODE); }
GEN_DONT_SANITIZE_UNDEFINED GEN_NAKED static void alo_interrupts_internal_exception_handler_x87_floating_point          (void) { ALO_INTERRUPTS_ISR_BODY(ALO_INTERRUPT_VECTOR_EXCEPTION_X87_FLOATING_POINT          , alo_interrupts_internal_exception_frame, alo_interrupts_internal_exception_stub, ALO_INTERRUPTS_NO_ERROR_CODE); }
GEN_DONT_SANITIZE_UNDEFINED GEN_NAKED static void alo_interrupts_internal_exception_handler_alignment_check             (void) { ALO_INTERRUPTS_ISR_BODY(ALO_INTERRUPT_VECTOR_EXCEPTION_ALIGNMENT_CHECK             , alo_interrupts_internal_exception_frame, alo_interrupts_internal_exception_stub, ALO_INTERRUPTS_ERROR_CODE   ); }
GEN_DONT_SANITIZE_UNDEFINED GEN_NAKED static void alo_interrupts_internal_exception_handler_machine_check               (void) { ALO_INTERRUPTS_ISR_BODY(ALO_INTERRUPT_VECTOR_EXCEPTION_MACHINE_CHECK               , alo_interrupts_internal_exception_frame, alo_interrupts_internal_exception_stub, ALO_INTERRUPTS_NO_ERROR_CODE); }
GEN_DONT_SANITIZE_UNDEFINED GEN_NAKED static void alo_interrupts_internal_exception_handler_simd_floating_point         (void) { ALO_INTERRUPTS_ISR_BODY(ALO_INTERRUPT_VECTOR_EXCEPTION_SIMD_FLOATING_POINT         , alo_interrupts_internal_exception_frame, alo_interrupts_internal_exception_stub, ALO_INTERRUPTS_NO_ERROR_CODE); }
GEN_DONT_SANITIZE_UNDEFINED GEN_NAKED static void alo_interrupts_internal_exception_handler_virtualization              (void) { ALO_INTERRUPTS_ISR_BODY(ALO_INTERRUPT_VECTOR_EXCEPTION_VIRTUALIZATION              , alo_interrupts_internal_exception_frame, alo_interrupts_internal_exception_stub, ALO_INTERRUPTS_NO_ERROR_CODE); }
GEN_DONT_SANITIZE_UNDEFINED GEN_NAKED static void alo_interrupts_internal_exception_handler_control_protection          (void) { ALO_INTERRUPTS_ISR_BODY(ALO_INTERRUPT_VECTOR_EXCEPTION_CONTROL_PROTECTION          , alo_interrupts_internal_exception_frame, alo_interrupts_internal_exception_stub, ALO_INTERRUPTS_NO_ERROR_CODE); }
GEN_DONT_SANITIZE_UNDEFINED GEN_NAKED static void alo_interrupts_internal_exception_handler_reserved1                   (void) { ALO_INTERRUPTS_ISR_BODY(ALO_INTERRUPT_VECTOR_EXCEPTION_RESERVED1                   , alo_interrupts_internal_exception_frame, alo_interrupts_internal_exception_stub, ALO_INTERRUPTS_NO_ERROR_CODE); }
GEN_DONT_SANITIZE_UNDEFINED GEN_NAKED static void alo_interrupts_internal_exception_handler_reserved2                   (void) { ALO_INTERRUPTS_ISR_BODY(ALO_INTERRUPT_VECTOR_EXCEPTION_RESERVED2                   , alo_interrupts_internal_exception_frame, alo_interrupts_internal_exception_stub, ALO_INTERRUPTS_NO_ERROR_CODE); }
GEN_DONT_SANITIZE_UNDEFINED GEN_NAKED static void alo_interrupts_internal_exception_handler_reserved3                   (void) { ALO_INTERRUPTS_ISR_BODY(ALO_INTERRUPT_VECTOR_EXCEPTION_RESERVED3                   , alo_interrupts_internal_exception_frame, alo_interrupts_internal_exception_stub, ALO_INTERRUPTS_NO_ERROR_CODE); }
GEN_DONT_SANITIZE_UNDEFINED GEN_NAKED static void alo_interrupts_internal_exception_handler_reserved4                   (void) { ALO_INTERRUPTS_ISR_BODY(ALO_INTERRUPT_VECTOR_EXCEPTION_RESERVED4                   , alo_interrupts_internal_exception_frame, alo_interrupts_internal_exception_stub, ALO_INTERRUPTS_NO_ERROR_CODE); }
GEN_DONT_SANITIZE_UNDEFINED GEN_NAKED static void alo_interrupts_internal_exception_handler_reserved5                   (void) { ALO_INTERRUPTS_ISR_BODY(ALO_INTERRUPT_VECTOR_EXCEPTION_RESERVED5                   , alo_interrupts_internal_exception_frame, alo_interrupts_internal_exception_stub, ALO_INTERRUPTS_NO_ERROR_CODE); }
GEN_DONT_SANITIZE_UNDEFINED GEN_NAKED static void alo_interrupts_internal_exception_handler_reserved6                   (void) { ALO_INTERRUPTS_ISR_BODY(ALO_INTERRUPT_VECTOR_EXCEPTION_RESERVED6                   , alo_interrupts_internal_exception_frame, alo_interrupts_internal_exception_stub, ALO_INTERRUPTS_NO_ERROR_CODE); }
GEN_DONT_SANITIZE_UNDEFINED GEN_NAKED static void alo_interrupts_internal_exception_handler_hypervisor_injection        (void) { ALO_INTERRUPTS_ISR_BODY(ALO_INTERRUPT_VECTOR_EXCEPTION_HYPERVISOR_INJECTION        , alo_interrupts_internal_exception_frame, alo_interrupts_internal_exception_stub, ALO_INTERRUPTS_NO_ERROR_CODE); }
GEN_DONT_SANITIZE_UNDEFINED GEN_NAKED static void alo_interrupts_internal_exception_handler_vmm_communication           (void) { ALO_INTERRUPTS_ISR_BODY(ALO_INTERRUPT_VECTOR_EXCEPTION_VMM_COMMUNICATION           , alo_interrupts_internal_exception_frame, alo_interrupts_internal_exception_stub, ALO_INTERRUPTS_ERROR_CODE   ); }
GEN_DONT_SANITIZE_UNDEFINED GEN_NAKED static void alo_interrupts_internal_exception_handler_security                    (void) { ALO_INTERRUPTS_ISR_BODY(ALO_INTERRUPT_VECTOR_EXCEPTION_SECURITY                    , alo_interrupts_internal_exception_frame, alo_interrupts_internal_exception_stub, ALO_INTERRUPTS_ERROR_CODE   ); }
GEN_DONT_SANITIZE_UNDEFINED GEN_NAKED static void alo_interrupts_internal_exception_handler_reserved7                   (void) { ALO_INTERRUPTS_ISR_BODY(ALO_INTERRUPT_VECTOR_EXCEPTION_RESERVED7                   , alo_interrupts_internal_exception_frame, alo_interrupts_internal_exception_stub, ALO_INTERRUPTS_NO_ERROR_CODE); }
