...
GEN_NAKED static void alo_interrupts_internal_exception_handler_device_not_avilable         (void) { ALO_INTERRUPTS_ISR_BODY(ALO_INTERRUPT_VECTOR_EXCEPTION_DEVICE_NOT_AVILABLE         , alo_interrupts_internal_exception_frame, alo_interrupts_internal_exception_stub, ALO_INTERRUPTS_NO_ERROR_CODE); }
