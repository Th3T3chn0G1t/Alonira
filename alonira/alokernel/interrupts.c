...
ALO_INTERRUPT_HANDLER_CALLABLE_ATTRIBUTES extern void alo_interrupts_internal_interrupt_stub(void);
GEN_NORETURN ALO_INTERRUPT_HANDLER_CALLABLE_ATTRIBUTES GEN_USED void alo_interrupts_internal_interrupt_stub(void) {
    (void) gen_log_formatted(GEN_LOG_LEVEL_DEBUG, "alonira-interrupt", "Exception: `%t` @ %p - Error Code: %ui", alo_interrupts_internal_exception_names[alo_interrupts_internal_exception_frame.vector], alo_interrupts_internal_exception_frame.registers.rip, alo_interrupts_internal_exception_frame.error_code.error_code);
    (void) gen_log_formatted(GEN_LOG_LEVEL_DEBUG, "alonira-interrupt", "ss: %us cs: %us", alo_interrupts_internal_exception_frame.ss.ss.selector, alo_interrupts_internal_exception_frame.cs.cs.selector);
...
#define ALO_INTERRUPTS_INTERNAL_EXCEPTION_BODY_NO_ERROR_CODE(exception_vector) \
    GEN_ASM_BLOCK( \
        ...
        GEN_ASM(.extern alo_interrupts_internal_interrupt_stub) \
        GEN_ASM(callq alo_interrupts_internal_interrupt_stub), \
    : \
        /* Exception Entry Frame */ \
...
GEN_NAKED static void alo_interrupts_internal_exception_handler_divide_by_zero              (void) { ALO_INTERRUPTS_INTERNAL_EXCEPTION_BODY_NO_ERROR_CODE(ALO_INTERRUPT_VECTOR_EXCEPTION_DIVIDE_BY_ZERO              ); }
GEN_NAKED static void alo_interrupts_internal_exception_handler_debug_trap                  (void) { ALO_INTERRUPTS_INTERNAL_EXCEPTION_BODY_NO_ERROR_CODE(ALO_INTERRUPT_VECTOR_EXCEPTION_DEBUG_TRAP                  ); }
GEN_NAKED static void alo_interrupts_internal_exception_handler_nmi                         (void) { ALO_INTERRUPTS_INTERNAL_EXCEPTION_BODY_NO_ERROR_CODE(ALO_INTERRUPT_VECTOR_EXCEPTION_NMI                         ); }
GEN_NAKED static void alo_interrupts_internal_exception_handler_breakpoint                  (void) { ALO_INTERRUPTS_INTERNAL_EXCEPTION_BODY_NO_ERROR_CODE(ALO_INTERRUPT_VECTOR_EXCEPTION_BREAKPOINT                  ); }
GEN_NAKED static void alo_interrupts_internal_exception_handler_overflow                    (void) { ALO_INTERRUPTS_INTERNAL_EXCEPTION_BODY_NO_ERROR_CODE(ALO_INTERRUPT_VECTOR_EXCEPTION_OVERFLOW                    ); }
GEN_NAKED static void alo_interrupts_internal_exception_handler_bound_range_exceeded        (void) { ALO_INTERRUPTS_INTERNAL_EXCEPTION_BODY_NO_ERROR_CODE(ALO_INTERRUPT_VECTOR_EXCEPTION_BOUND_RANGE_EXCEEDED        ); }
GEN_NAKED static void alo_interrupts_internal_exception_handler_invalid_opcode              (void) { ALO_INTERRUPTS_INTERNAL_EXCEPTION_BODY_NO_ERROR_CODE(ALO_INTERRUPT_VECTOR_EXCEPTION_INVALID_OPCODE              ); }
GEN_NAKED static void alo_interrupts_internal_exception_handler_device_not_avilable         (void) { ALO_INTERRUPTS_INTERNAL_EXCEPTION_BODY_NO_ERROR_CODE(ALO_INTERRUPT_VECTOR_EXCEPTION_DEVICE_NOT_AVILABLE         ); }
GEN_NAKED static void alo_interrupts_internal_exception_handler_double_fault                (void) { ALO_INTERRUPTS_INTERNAL_EXCEPTION_BODY_NO_ERROR_CODE(ALO_INTERRUPT_VECTOR_EXCEPTION_DOUBLE_FAULT                ); }
GEN_NAKED static void alo_interrupts_internal_exception_handler_coprocessor_segment_overrun (void) { ALO_INTERRUPTS_INTERNAL_EXCEPTION_BODY_NO_ERROR_CODE(ALO_INTERRUPT_VECTOR_EXCEPTION_COPROCESSOR_SEGMENT_OVERRUN ); }
GEN_NAKED static void alo_interrupts_internal_exception_handler_invalid_tss                 (void) { ALO_INTERRUPTS_INTERNAL_EXCEPTION_BODY_NO_ERROR_CODE(ALO_INTERRUPT_VECTOR_EXCEPTION_INVALID_TSS                 ); }
GEN_NAKED static void alo_interrupts_internal_exception_handler_segment_not_present         (void) { ALO_INTERRUPTS_INTERNAL_EXCEPTION_BODY_NO_ERROR_CODE(ALO_INTERRUPT_VECTOR_EXCEPTION_SEGMENT_NOT_PRESENT         ); }
GEN_NAKED static void alo_interrupts_internal_exception_handler_stack_segment_fault         (void) { ALO_INTERRUPTS_INTERNAL_EXCEPTION_BODY_NO_ERROR_CODE(ALO_INTERRUPT_VECTOR_EXCEPTION_STACK_SEGMENT_FAULT         ); }
GEN_NAKED static void alo_interrupts_internal_exception_handler_general_protection_fault    (void) { ALO_INTERRUPTS_INTERNAL_EXCEPTION_BODY_NO_ERROR_CODE(ALO_INTERRUPT_VECTOR_EXCEPTION_GENERAL_PROTECTION_FAULT    ); }
GEN_NAKED static void alo_interrupts_internal_exception_handler_page_fault                  (void) { ALO_INTERRUPTS_INTERNAL_EXCEPTION_BODY_NO_ERROR_CODE(ALO_INTERRUPT_VECTOR_EXCEPTION_PAGE_FAULT                  ); }
GEN_NAKED static void alo_interrupts_internal_exception_handler_reserved0                   (void) { ALO_INTERRUPTS_INTERNAL_EXCEPTION_BODY_NO_ERROR_CODE(ALO_INTERRUPT_VECTOR_EXCEPTION_RESERVED0                   ); }
GEN_NAKED static void alo_interrupts_internal_exception_handler_x87_floating_point          (void) { ALO_INTERRUPTS_INTERNAL_EXCEPTION_BODY_NO_ERROR_CODE(ALO_INTERRUPT_VECTOR_EXCEPTION_X87_FLOATING_POINT          ); }
GEN_NAKED static void alo_interrupts_internal_exception_handler_alignment_check             (void) { ALO_INTERRUPTS_INTERNAL_EXCEPTION_BODY_NO_ERROR_CODE(ALO_INTERRUPT_VECTOR_EXCEPTION_ALIGNMENT_CHECK             ); }
GEN_NAKED static void alo_interrupts_internal_exception_handler_machine_check               (void) { ALO_INTERRUPTS_INTERNAL_EXCEPTION_BODY_NO_ERROR_CODE(ALO_INTERRUPT_VECTOR_EXCEPTION_MACHINE_CHECK               ); }
GEN_NAKED static void alo_interrupts_internal_exception_handler_simd_floating_point         (void) { ALO_INTERRUPTS_INTERNAL_EXCEPTION_BODY_NO_ERROR_CODE(ALO_INTERRUPT_VECTOR_EXCEPTION_SIMD_FLOATING_POINT         ); }
GEN_NAKED static void alo_interrupts_internal_exception_handler_virtualization              (void) { ALO_INTERRUPTS_INTERNAL_EXCEPTION_BODY_NO_ERROR_CODE(ALO_INTERRUPT_VECTOR_EXCEPTION_VIRTUALIZATION              ); }
GEN_NAKED static void alo_interrupts_internal_exception_handler_control_protection          (void) { ALO_INTERRUPTS_INTERNAL_EXCEPTION_BODY_NO_ERROR_CODE(ALO_INTERRUPT_VECTOR_EXCEPTION_CONTROL_PROTECTION          ); }
GEN_NAKED static void alo_interrupts_internal_exception_handler_reserved1                   (void) { ALO_INTERRUPTS_INTERNAL_EXCEPTION_BODY_NO_ERROR_CODE(ALO_INTERRUPT_VECTOR_EXCEPTION_RESERVED1                   ); }
GEN_NAKED static void alo_interrupts_internal_exception_handler_reserved2                   (void) { ALO_INTERRUPTS_INTERNAL_EXCEPTION_BODY_NO_ERROR_CODE(ALO_INTERRUPT_VECTOR_EXCEPTION_RESERVED2                   ); }
GEN_NAKED static void alo_interrupts_internal_exception_handler_reserved3                   (void) { ALO_INTERRUPTS_INTERNAL_EXCEPTION_BODY_NO_ERROR_CODE(ALO_INTERRUPT_VECTOR_EXCEPTION_RESERVED3                   ); }
GEN_NAKED static void alo_interrupts_internal_exception_handler_reserved4                   (void) { ALO_INTERRUPTS_INTERNAL_EXCEPTION_BODY_NO_ERROR_CODE(ALO_INTERRUPT_VECTOR_EXCEPTION_RESERVED4                   ); }
GEN_NAKED static void alo_interrupts_internal_exception_handler_reserved5                   (void) { ALO_INTERRUPTS_INTERNAL_EXCEPTION_BODY_NO_ERROR_CODE(ALO_INTERRUPT_VECTOR_EXCEPTION_RESERVED5                   ); }
GEN_NAKED static void alo_interrupts_internal_exception_handler_reserved6                   (void) { ALO_INTERRUPTS_INTERNAL_EXCEPTION_BODY_NO_ERROR_CODE(ALO_INTERRUPT_VECTOR_EXCEPTION_RESERVED6                   ); }
GEN_NAKED static void alo_interrupts_internal_exception_handler_hypervisor_injection        (void) { ALO_INTERRUPTS_INTERNAL_EXCEPTION_BODY_NO_ERROR_CODE(ALO_INTERRUPT_VECTOR_EXCEPTION_HYPERVISOR_INJECTION        ); }
GEN_NAKED static void alo_interrupts_internal_exception_handler_vmm_communication           (void) { ALO_INTERRUPTS_INTERNAL_EXCEPTION_BODY_NO_ERROR_CODE(ALO_INTERRUPT_VECTOR_EXCEPTION_VMM_COMMUNICATION           ); }
GEN_NAKED static void alo_interrupts_internal_exception_handler_security                    (void) { ALO_INTERRUPTS_INTERNAL_EXCEPTION_BODY_NO_ERROR_CODE(ALO_INTERRUPT_VECTOR_EXCEPTION_SECURITY                    ); }
GEN_NAKED static void alo_interrupts_internal_exception_handler_reserved7                   (void) { ALO_INTERRUPTS_INTERNAL_EXCEPTION_BODY_NO_ERROR_CODE(ALO_INTERRUPT_VECTOR_EXCEPTION_RESERVED7                   ); }
