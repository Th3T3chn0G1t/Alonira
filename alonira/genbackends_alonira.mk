$(GEN_BACKENDS_ALONIRA_LIB): CFLAGS = $(GEN_BACKENDS_ALONIRA_INTERNAL_CFLAGS) $(KERNEL_GEN_CORE_CFLAGS) $(ALO_KERNEL_CFLAGS) -Wno-c++-compat -Wno-gnu-empty-struct -Wno-unused-parameter
