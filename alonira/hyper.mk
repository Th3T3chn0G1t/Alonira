...
$(HYPER_CMAKE_CACHE):
	@$(ECHO) "$(ACTION_PREFIX)"
	$(CMAKE) -G "Unix Makefiles" -DHYPER_TOOLCHAIN=clang -DHYPER_SERIAL_LOG=On -DHYPER_SERIAL_BAUD_RATE=9600 -DCMAKE_C_COMPILER=$(CLANG) -DCMAKE_ASM_NASM_COMPILER=$(NASM) -B$@ $(dir $@)
	@$(ECHO) "$(ACTION_SUFFIX)"
