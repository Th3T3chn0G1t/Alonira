...
$(ALO_KERNEL): CFLAGS = $(KERNEL_GEN_CORE_CFLAGS) $(GENSTONE_DIAGNOSTIC_CFLAGS) $(ALO_KERNEL_CFLAGS)
$(ALO_KERNEL): LFLAGS = $(KERNEL_GEN_CORE_LIB) -T$(ALONIRA_DIR)/alonira/alokernel/scripts/kernel-$(KERNEL_TARGET).ld $(GEN_BACKENDS_ALONIRA_LIB)
