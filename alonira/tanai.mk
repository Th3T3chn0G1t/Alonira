...
$(TANAI_LIB): CFLAGS = $(GEN_CORE_CFLAGS) $(GENSTONE_DIAGNOSTIC_CFLAGS) -Wno-gnu-binary-literal
...
$(TANAI_WRITER): CFLAGS = $(TANAI_CFLAGS) $(GENSTONE_DIAGNOSTIC_CFLAGS) -Wno-gnu-binary-literal
