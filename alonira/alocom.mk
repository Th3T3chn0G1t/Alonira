ALOCOM_C_FLAGS = -Ialonira/alocom/include -march=x86-64 -m64 --target=x86_64-none-elf -fstack-protector-all -fsanitize=undefined,cfi
...
ALOCOM_L_FLAGS = -Llib -lalonira-common -march=x86-64 -m64 --target=x86_64-none-elf -fstack-protector-all -fsanitize=undefined,cfi
...
ALOCOM_OBJECTS = $(ALOCOM_SOURCES:.c=.c$(OBJECT_SUFFIX))
