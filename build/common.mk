...
%$(TARGET_C_OBJECT_SUFFIX): %.c
	@$(ECHO) "$(ACTION_PREFIX)$(CLANG) -c $(TARGET_GLOBAL_CFLAGS) $(TARGET_CFLAGS) -o $@ $<$(ACTION_SUFFIX)"
	@$(CLANG) -c $(TARGET_GLOBAL_CFLAGS) $(TARGET_CFLAGS) -o $@ $<

	@$(ECHO) "$(ACTION_PREFIX)$(CLANG) $(TARGET_GLOBAL_CFLAGS) $(TARGET_CFLAGS) --analyze $(SAFLAGS) $<$(ACTION_SUFFIX)"
	@$(CLANG) $(TARGET_GLOBAL_CFLAGS) $(TARGET_CFLAGS) --analyze $(SAFLAGS) $<

%$(TARGET_ASM_OBJECT_SUFFIX): %.asm
	@$(ECHO) "$(ACTION_PREFIX)$(NASM) $(TARGET_GLOBAL_ASMFLAGS) $(TARGET_ASMFLAGS) -o $@ $<$(ACTION_SUFFIX)"
	@$(NASM) $(TARGET_GLOBAL_ASMFLAGS) $(TARGET_ASMFLAGS) -o $@ $<
